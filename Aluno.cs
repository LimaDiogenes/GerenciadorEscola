namespace GerenciadorEscola
{
    internal class Aluno : Pessoa
    {
        ...
        internal Aluno(int matricula, string nome, DateTime dataNascimento)        
            :base(matricula, nome, dataNascimento)
        {
        ...
        internal void MatricularEmCurso(Curso curso)
        {
            if (!Cursos.Contains(curso))
            {
                ...
                Console.WriteLine($"Parabéns aniversariante. Você ganhou 10% de desconto!!!");
